...
const animatedElements = document.querySelectorAll(
    '.timeline-item, .project-card, .skill-category, .education-card, .contact-info, .contact-form'
);
...
contactForm.addEventListener('submit', (e) => {
    ...
    setTimeout(() => {
        ...
        submitButton.style.background = 'linear-gradient(135deg, #00cc6a 0%, #00ff88 100%)';
...
// Smooth reveal for language progress bars
...
console.log('%c🚀 Welcome to Koubalika E. Fernandez Portfolio!', 'color: #00ff88; font-size: 20px; font-weight: bold;');
console.log('%cBuilt with HTML, CSS, and JavaScript', 'color: #00d4ff; font-size: 14px;');
